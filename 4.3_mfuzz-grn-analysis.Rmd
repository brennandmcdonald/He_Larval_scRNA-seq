...
Note that obtaining a GRN list that matched the genes in the Seurat object required some manual curation. To avoid ambiguities with this, you can skip this code block and move to the next section, "Analyze the expression profiles of GRN and TF genes", for which the need data files are provided.

...
save(neural_sub, 
     file = "6-60hr\ Integrated\ UMAP/neural-analysis/neural_subcluster-seurat-object.Rda")
```
...
write.csv(export, "6-60hr\ Integrated\ UMAP/neural-analysis/top-neural-markers.csv",
          row.names = F)
```
...
```{r}
hery_spu <- read_tsv("6-60hr\ Integrated\ UMAP/neural-analysis/H_ery_SPU_hits_best.txt")
neural_spu <- read_tsv("6-60hr\ Integrated\ UMAP/neural-analysis/neural_tfs.txt")
```
...
write.csv(neural_hery, "6-60hr\ Integrated\ UMAP/neural-analysis/neural_tfs_hery.csv",
          row.names = F)
...
neural_tf <- read_csv("6-60hr\ Integrated\ UMAP/neural-analysis/neural_tfs_hery.csv")
